                    ...
                    <tr>
                        ...
                        <th>
                            <div class="form-group">
                                <input type="text" class="form-control" name="{{"jk$loop"}}" id=""
                                    value="{{$i->jarak_kampus}}">
                            </div>
                        </th>
                        <th>
                            <div class="form-group">
                                <input type="text" class="form-control" name="j{{"m$loop"}}" id=""
                                    value="{{$i->jarak_market}}">
                            </div>
                        </th>
                        <th>
                            <div class="form-group">
                        ...
                        <th>
                            <div class="form-group">
                                <input type="text" class="form-control" name="k{{"b$loop"}}" id=""
                                    value="{{$i->kebersihan}}">
                            </div>
                        </th>
                        <th>
                            <div class="form-group">
                                <input type="text" class="form-control" name="k{{"a$loop"}}" id=""
                                    value="{{$i->keamanan}}">
                            </div>
                        </th>
                        <th>
                            <div class="form-group">
                                <input type="text" class="form-control" name="{{"f$loop"}}" id=""
                                    value="{{$i->fasilitas}}">
                            </div>
                        </th>
                    </tr>
